 ...
 * Portfolio Post Type
 *
 * @package   Tuan_Portfolio_Post_Type
 * @author    Tuan Anh Le
 * @license   GPL-2.0+
 * @link      https://themestar.co.uk/
 * @copyright 2016 Tuan Anh Le 
 *
 * @wordpress-plugin
 * Plugin Name: Tuan Portfolio Post Type
 * Plugin URI: https://themestar.co.uk/
 * Description: Enables a portfolio post type and taxonomies.
 * Version:     1.0.0
 * Author:      Tuan Anh Le
 * Author URI: https://themestar.co.uk/
...
//Required files for registering custom post type.
require plugin_dir_path( __FILE__ ) . 'includes/class-service-post-type-post-type.php';

//Required files for registering custom post type.
require plugin_dir_path( __FILE__ ) . 'includes/class-courses-post-type-post-type.php';
