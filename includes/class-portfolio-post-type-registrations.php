 ...
 * @author   Tuan Anh Le
   @author    Tuan Anh Le
 * @license   GPL-2.0+
 * @link      http://themestar/portfolio-post-type/
...
class Portfolio_Post_Type_Registrations {
	...
	public function register() {
		global $portfolio_post_type_post_type,$service_post_type_post_type,$courses_post_type_post_type,$portfolio_post_type_taxonomy_category, $portfolio_post_type_taxonomy_tag;
		...
		$courses_post_type_post_type = new Courses_Post_Type_Post_Type;
		$courses_post_type_post_type->register();
		$this->post_type = $courses_post_type_post_type->get_post_type();
	}
	...
	public function unregister() {
        ...
        $service_post_type_post_type->unregister();
		$this->post_type = null;

		 $courses_post_type_post_type->unregister();
		$this->post_type = null;
